...
export interface PaymentMethod {
  ...
  limit?: number;
  currentUsage?: number;
  deductionDate?: number; // Day of month when card is charged
  linkedBankAccount?: number; // Index of the bank account this card is linked to
}
...
export interface InsuranceType {
  type: 'vehicle' | 'home' | 'health' | 'other';
  amount: number;
  provider?: string;
}
