  ...
  const handleAddCard = () => {
    if (newCard.name.trim() && (newCard.type !== 'creditCard' || newCard.limit)) {
      addPaymentMethod({
        ...
        cardType: newCard.type === 'creditCard' ? newCard.cardType as any : undefined,
                ...
                <View style={styles.cardItem}>
                  ...
                  <View style={styles.cardDetails}>
                    ...
                    <Text style={styles.cardType}>
                      {t(method.type as any)}
                      {method.cardType && ` - ${t(method.cardType as any)}`}
                    </Text>
        ...
        <View style={styles.section}>
          <View style={styles.card}>
            <Pressable 
              style={[
                styles.dangerButton,
                isLoggingOut && styles.dangerButtonDisabled
              ]}
